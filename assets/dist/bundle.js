...
exports.default = {
  translations: {
    ...
    storage: {
      ...
      storage_description: {
        en: 'Storage Description',
        ja: '収納場所の説明'
      },
      please_create_one: {
        en: 'Please create at least one storage space before you add any items.',
        ja: '品物の登録をする前に、収納場所を作成してください。'
      },
      save_success: {
        en: 'Storage saved successfully.',
        ja: 'ストレージセーブ完了'
      },
      delete_success: {
        en: 'Storage deleted successfully.',
        ja: 'ストレージ消去完了'
      },
      duplicate_exists: {
        en: 'Duplicate storage exists.',
        ja: '重複したストレージがあります。'
      },
      not_empty: {
        en: 'Duplicate storage exists.',
...
module.exports = {
	...
	methods: {
		translate: function translate(namespace, locale) {
			...
			try {
				var translation = namespace.split('.').reduce(function (a, b, index) {
					return (typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'object' ? a[b] : data[a][b];
				})[locale];
			} catch (e) {
...
module.exports.templates = __webpack_require__(80);
...
exports.default = {
  methods: {
    formToString: function formToString(form_id) {
...
var ValidationBag = __webpack_require__(19);
...
var alphabets = exports.alphabets = function alphabets() {
  var data_alphabets = [];
...
ValidationBag.prototype.setError = function (field, message) {
  ...
  if (!hasPromise) {
    ...
    return Promise.all(messages).then(function (messages) {
...
var _simpleVueValidator = __webpack_require__(11);
...
var _items = __webpack_require__(47);

var _items2 = _interopRequireDefault(_items);

var _storageSpaces = __webpack_require__(48);

var _storageSpaces2 = _interopRequireDefault(_storageSpaces);
...
var mutations = {
  ...
  SET_ERROR: function SET_ERROR(state, message) {
    state.prompt.message = message;
  ...
  //FORMS
  SET_FORM_SHOWN: function SET_FORM_SHOWN(state, isShown) {
    state.form.shown = isShown;
  },
  SET_FORM_MODE: function SET_FORM_MODE(state, mode) {
    state.form.form_mode = mode;
  },
  SET_ITEM_FORM_SHOWN: function SET_ITEM_FORM_SHOWN(state, isShown) {
    state.form.itemFormShown = isShown;
  },
  SET_STORAGE_LIST_SHOWN: function SET_STORAGE_LIST_SHOWN(state, isShown) {
    state.form.storageListShown = isShown;
  },
  SET_STORAGE_FORM_SHOWN: function SET_STORAGE_FORM_SHOWN(state, isShown) {
    state.form.storageFormShown = isShown;
  },


  //FIND
  SET_SEARCHING: function SET_SEARCHING(state, arg_isSearching) {
...
exports.default = new _vuex2.default.Store({
  ...
  modules: {
    ...
    storageSpaces: _storageSpaces2.default
  }
});
...
var _vueI18nMixin = __webpack_require__(4);

var _vueI18nMixin2 = _interopRequireDefault(_vueI18nMixin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// LOGIN
var check_login = exports.check_login = function check_login(_ref) {
  var commit = _ref.commit;

  var self = undefined;
  _axios2.default.post('/users/login/check').then(function (response) {
    commit('SET_LOGIN_STATUS', response.data);
  }).catch(function (error) {
    console.log(error);
  });
};
var login = exports.login = function login(store, input) {
  _axios2.default.post('/users/login', input).then(function (response) {
    if (response.data) {
...
//PROMPT
var set_prompt = exports.set_prompt = function set_prompt(_ref2, data) {
...
//FIND
var find_item = exports.find_item = function find_item(store, e) {
  find_item_func(store, e.target.value);
};
var find_item_evoke = exports.find_item_evoke = function find_item_evoke(store) {
  find_item_func(store, document.getElementById('fld_find').value);
};
var find_item_func = exports.find_item_func = function find_item_func(store, str_search) {
  if (str_search.length >= 2) {
    var array_search_str = str_search.split(' ');
    array_search_str = array_search_str.filter(function (str) {
      return str.length > 1;
    });
    var filtered_items = store.rootState.items.all.filter(function (item) {
...
//FORM
var close_form = exports.close_form = function close_form(_ref3) {
...
var open_form = exports.open_form = function open_form(_ref4) {
  var commit = _ref4.commit;

  commit('SET_FORM_SHOWN', true);
};
var set_form_mode = exports.set_form_mode = function set_form_mode(_ref5, mode) {
  var commit = _ref5.commit;

  commit('SET_FORM_MODE', mode);
};
var show_item_form = exports.show_item_form = function show_item_form(store) {
...
var show_storage_list = exports.show_storage_list = function show_storage_list(store) {
...
var close_storage_list = exports.close_storage_list = function close_storage_list(store) {
  set_form_mode(store, 'storageList');
  setTimeout(function () {
    store.commit('SET_ITEM_FORM_SHOWN', true);
    store.commit('SET_STORAGE_LIST_SHOWN', false);
...
var show_storage_form = exports.show_storage_form = function show_storage_form(store) {
...
var close_storage_form = exports.close_storage_form = function close_storage_form(_ref6) {
...
var getterEagle = exports.getterEagle = function getterEagle(state) {
	return 'Getter Eagle';
};
...
var actions = {
  load_items: function load_items(store) {
    _axios2.default.post('/items/load').then(function (response) {
  ...
  add_new_item: function add_new_item(store) {
  ...
  set_active_item: function set_active_item(store, item) {
    store.commit('SET_ACTIVE_ITEM', item);
    store.dispatch('open_form', store);
  },
  upload_image: function upload_image(store) {
    var data = new FormData();
    data.append('files', document.getElementById('fileupload').files[0]);
    _axios2.default.post('/items/image_upload', data, {
      headers: {
...
var mutations = {
  ...
  SET_FILTERED_ITEMS: function SET_FILTERED_ITEMS(state, filtered_items) {
    state.filtered = filtered_items;
  },
  SET_ACTIVE_ITEM: function SET_ACTIVE_ITEM(state, item) {
    state.active = item;
  },
  ADD_ITEM: function ADD_ITEM(state, storage_id_default) {
    var empty_item = {
      photos: [],
      item_id: 0,
      item_name: '',
  ...
  ADD_ACTIVE_ITEM_PHOTO: function ADD_ACTIVE_ITEM_PHOTO(state, photo) {
    state.active.photos.push(photo);
  },
  UPDATE_ACTIVE_STORAGE_ID: function UPDATE_ACTIVE_STORAGE_ID(state, value) {
    state.active.storage_id = value;
  },
  UPDATE_ACTIVE_ITEM_NAME: function UPDATE_ACTIVE_ITEM_NAME(state, value) {
    state.active.item_name = value;
  },
  UPDATE_ACTIVE_ITEM_DESCRIPTION: function UPDATE_ACTIVE_ITEM_DESCRIPTION(state, value) {
    state.active.item_description = value;
  }
};

var getters = {
  get_items: function get_items(state, getters, rootState) {
...
var actions = {
  load_storage: function load_storage(_ref) {
    var commit = _ref.commit;

    var request = _axios2.default.post('/storage/load').then(function (response) {
      if (response.data.length > 0) {
  ...
  set_active_storage: function set_active_storage(store, storage) {
  ...
  delete_storage: function delete_storage(store) {
    if (store.state.active.storage_id) {
      var r = confirm("Are you sure?");
      if (r == true) {
        var input = 'storage_id=' + store.state.active.storage_id;
        _axios2.default.post('/storage/delete', input).then(function (response) {
  ...
  save_storage: function save_storage(store, input) {
    _axios2.default.post('/storage/save', input).then(function (response) {
      if (response.data.success) {
        store.dispatch('load_storage', store).then(function (result) {
...
var mutations = {
  LOAD_STORAGE: function LOAD_STORAGE(state, storage_spaces) {
  ...
  ADD_STORAGE: function ADD_STORAGE(state) {
    var empty_storage = {
      storage_id: 0,
      storage_prefix: 'A',
      storage_number: '1',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_app_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_28960a80_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_app_vue__ = __webpack_require__(94);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_28960a80_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_app_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/app.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-28960a80", Component.options)
  } else {
    hotAPI.reload("data-v-28960a80", Component.options)
' + '  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login_vue__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__find_vue__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__prompt_vue__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dashboard_vue__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboard_forms_vue__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bottom_widgets_vue__ = __webpack_require__(91);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'app',
  methods: Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])(['check_login']),
  created() {
    this.check_login();
  },
  components: {
    Login: __WEBPACK_IMPORTED_MODULE_1__login_vue__["a" /* default */], Find: __WEBPACK_IMPORTED_MODULE_2__find_vue__["a" /* default */], Prompt: __WEBPACK_IMPORTED_MODULE_3__prompt_vue__["a" /* default */], Dashboard: __WEBPACK_IMPORTED_MODULE_4__dashboard_vue__["a" /* default */], Forms: __WEBPACK_IMPORTED_MODULE_5__dashboard_forms_vue__["a" /* default */], BottomWidgets: __WEBPACK_IMPORTED_MODULE_6__bottom_widgets_vue__["a" /* default */]
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_login_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_51760648_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_login_vue__ = __webpack_require__(53);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_51760648_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_login_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-51760648", Component.options)
  } else {
    hotAPI.reload("data-v-51760648", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_mixins_functions__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_translations_translations__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_translations_translations___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vue_translations_translations__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__vue_mixins_functions___default.a, __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin___default.a, __WEBPACK_IMPORTED_MODULE_1__vue_translations_translations___default.a],
  data() {
    return {
      email: '',
      password: ''
  ...
  computed: Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["mapState"])({
...
var render = function() {
  ...
  return _c("div", { staticClass: "splash-container" }, [
    _c(
      "div",
      { staticClass: "splash" },
      [
        _c("transition", { attrs: { name: "slideUp", appear: "" } }, [
          _vm.loggedInChecked && !_vm.loggedIn
            ? _c("div", { staticClass: "splash-inner" }, [
                  ...
                  "form",
                  {
                    ...
                    on: {
                      submit: function($event) {
                        ...
                        _vm.login_submit($event)
                      }
                    }
                  },
                  [
                    _c("label", { attrs: { for: "email" } }, [
                      _vm._v(_vm._s(this.translate("login.email")))
                    ]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                    ...
                    _c("label", { attrs: { for: "password" } }, [
                      _vm._v(_vm._s(this.translate("login.password")))
                    ]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                    ...
                    _c("input", {
                      attrs: { type: "submit" },
                      domProps: { value: this.translate("login.login") }
                    })
                  ]
                )
              ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-51760648", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_find_vue__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1f732e2a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_find_vue__ = __webpack_require__(56);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_find_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1f732e2a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_find_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/find.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1f732e2a", Component.options)
  } else {
    hotAPI.reload("data-v-1f732e2a", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_translations_translations__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_translations_translations___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vue_translations_translations__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_i18n_mixin__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_i18n_mixin___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_i18n_mixin__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_1_vue_i18n_mixin___default.a, __WEBPACK_IMPORTED_MODULE_0__vue_translations_translations___default.a],
  computed: Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapState"])({
    locale: state => state.locale
  }),
  methods: Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapActions"])(['find_item'])
});
...
var render = function() {
  ...
  return this.$store.state.loggedIn
    ? _c("div", { attrs: { id: "find" } }, [
        _c("div", { attrs: { id: "find-inner" } }, [
          _c("div", { staticClass: "pure-g" }, [
            _c("div", { staticClass: "pure-u-21-24" }, [
              _c("input", {
                attrs: {
                  type: "text",
                  id: "fld_find",
                  name: "find",
                  placeholder: this.translate("find.find_something")
                },
                on: { input: _vm.find_item }
              })
            ]),
            _vm._v(" "),
            _vm._m(0)
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pure-u-3-24" }, [
      _c("input", { attrs: { type: "button", id: "btn_find" } })
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1f732e2a", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_prompt_vue__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f5f8dbd6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_prompt_vue__ = __webpack_require__(59);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_prompt_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f5f8dbd6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_prompt_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/prompt.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f5f8dbd6", Component.options)
  } else {
    hotAPI.reload("data-v-f5f8dbd6", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { attrs: { id: "prompt-wrapper" } },
    [
      _c("transition", { attrs: { name: "slideAway", appear: "" } }, [
        _vm.showPrompt
          ? _c(
              "div",
              {
                class: { message: true, error: _vm.isError },
                attrs: { id: "prompt" }
              },
              [
                _vm._v(
                  "\n      " + _vm._s(this.translate(_vm.message)) + "\n    "
                )
              ]
            )
          : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f5f8dbd6", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_dashboard_vue__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3697b873_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_dashboard_vue__ = __webpack_require__(68);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3697b873_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_dashboard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3697b873", Component.options)
  } else {
    hotAPI.reload("data-v-3697b873", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dashboard_items_vue__ = __webpack_require__(62);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    Items: __WEBPACK_IMPORTED_MODULE_3__dashboard_items_vue__["a" /* default */]
  },
  updated() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_items_vue__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a69716b8_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_items_vue__ = __webpack_require__(67);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a69716b8_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_items_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/items.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a69716b8", Component.options)
  } else {
    hotAPI.reload("data-v-a69716b8", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__item_vue__ = __webpack_require__(64);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_item_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ebe385f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_item_vue__ = __webpack_require__(66);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ebe385f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_item_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ebe385f", Component.options)
  } else {
    hotAPI.reload("data-v-2ebe385f", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ['item'],
  computed: {
    photo_fileName: function () {
      if (this.item.photos.length) {
        return '/uploaded-files/' + this.item.photos[0].fileName;
      } else {
        return '/assets/images/icon-photo-sm.png';
      }
    }
  },
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])(['set_active_item']), {
    testanimation() {
      this.$store.dispatch('remove_one');
    }
  })
});
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "item pure-g cursor",
      on: {
        click: function($event) {
          _vm.set_active_item(_vm.item)
        }
      }
    },
    [
      _c("div", {
        staticClass: "pure-u-4-24 photo",
        style: { "background-image": "url(" + _vm.photo_fileName + ")" }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "pure-u-16-24 content" }, [
        _c("h2", [_vm._v(_vm._s(_vm.item.item_name))]),
        _c("p", [_vm._v(_vm._s(_vm.item.item_description))])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "pure-u-4-24 label" }, [
        _vm._v(
          _vm._s(_vm.item.storage_prefix) +
            " " +
            _vm._s(_vm.item.storage_number)
        )
      ])
    ]
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2ebe385f", esExports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "box", attrs: { id: "items" } },
    [
      _c(
        "transition-group",
        { attrs: { name: "listmove" } },
        _vm._l(_vm.items, function(item) {
          return _c("item", { key: item.item_id, attrs: { item: item } })
        })
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a69716b8", esExports)
  }
}
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _vm.loggedIn
    ? _c("div", { attrs: { id: "dashboard" } }, [
        !_vm.hasItems
          ? _c(
              "div",
              { staticClass: "splash-container", attrs: { id: "no-result" } },
              [
                _c("div", { staticClass: "splash" }, [
                  _vm._v(
                    "— " + _vm._s(this.translate("dashboard.no_results")) + " —"
                  )
                ])
              ]
            )
        ...
        _vm._v(" "),
        _vm.hasItems
          ? _c("div", { attrs: { id: "search-result" } }, [_c("items")], 1)
          : _vm._e()
      ])
    : _vm._e()
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3697b873", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_forms_vue__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cf9b6cda_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_forms_vue__ = __webpack_require__(90);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_forms_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cf9b6cda_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_forms_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/forms.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cf9b6cda", Component.options)
  } else {
    hotAPI.reload("data-v-cf9b6cda", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuex__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__item_form_vue__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage_list_vue__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__storage_form_vue__ = __webpack_require__(87);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])(['show_item_form', 'close_form']),
	components: {
		ItemForm: __WEBPACK_IMPORTED_MODULE_1__item_form_vue__["a" /* default */],
		StorageList: __WEBPACK_IMPORTED_MODULE_2__storage_list_vue__["a" /* default */],
		StorageForm: __WEBPACK_IMPORTED_MODULE_3__storage_form_vue__["a" /* default */]
	}
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_item_form_vue__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_560a3f22_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_item_form_vue__ = __webpack_require__(83);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_item_form_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_560a3f22_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_item_form_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/item-form.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-560a3f22", Component.options)
  } else {
    hotAPI.reload("data-v-560a3f22", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_constants_constants__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_constants_constants___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__vue_constants_constants__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__photo_preview_vue__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_simple_vue_validator__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_simple_vue_validator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_simple_vue_validator__);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Validator = __WEBPACK_IMPORTED_MODULE_6_simple_vue_validator___default.a.Validator;

/* harmony default export */ __webpack_exports__["a"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__vue_mixins_functions___default.a, __WEBPACK_IMPORTED_MODULE_1__vue_translations_translations___default.a, __WEBPACK_IMPORTED_MODULE_2_vue_i18n_mixin___default.a],
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_4_vuex__["mapState"])({
    locale: state => state.locale,
  ...
  }), Object(__WEBPACK_IMPORTED_MODULE_4_vuex__["mapGetters"])([]), {
    storage_id: {
      get() {
  ...
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_4_vuex__["mapActions"])(['show_storage_list', 'upload_image', 'item_form_submit', 'close_form']), {
  ...
  components: {
    PhotoPreview: __WEBPACK_IMPORTED_MODULE_5__photo_preview_vue__["a" /* default */]
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_photo_preview_vue__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3388b591_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_photo_preview_vue__ = __webpack_require__(75);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_photo_preview_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3388b591_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_photo_preview_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/photo-preview.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3388b591", Component.options)
  } else {
    hotAPI.reload("data-v-3388b591", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("span", {
    ...
    style: {
      "background-image":
        "url(/uploaded-files/thumbs/" + _vm.photodata.thumbName + ")"
    },
    attrs: { title: _vm.photodata.filename }
  })
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3388b591", esExports)
  }
}
...
function getPromise() {
  ...
  return __webpack_require__(20).Promise;
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("transition", { attrs: { name: _vm.itemFormTransition } }, [
    _vm.showItemForm
      ? _c("div", { staticClass: "pure-g", attrs: { id: "item-add" } }, [
              ...
              _c("form", { attrs: { id: "upload-form" } }, [
                _c(
                  "label",
                  {
                    ...
                    attrs: { id: "lbl-fileupload", for: "fileupload" }
                  },
                  [_vm._v(_vm._s(this.translate("item.upload_photos")))]
                ),
                _vm._v(" "),
                _c("input", {
                  staticStyle: { display: "none" },
                  attrs: { id: "fileupload", type: "file", name: "files" },
            ...
            _c(
              ...
              [
                _c(
                  ...
                  [
                    _vm._l(_vm.photoPreviews, function(photo) {
                      return _c("photo-preview", {
                        key: photo.photo_id,
                        attrs: { photodata: photo }
                      })
                    }),
                    _vm._v(" "),
                    _c("input", {
                      attrs: { type: "hidden", name: "uploaded_files" },
                      domProps: { value: _vm.uploadedFiles }
                    })
                  ],
                  2
                ),
                ...
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("label", [
                    _vm._v(_vm._s(this.translate("item.storage")) + " "),
                    _c("div", {
                      staticClass: "btn sm cog",
                      on: { click: _vm.show_storage_list }
                    })
                  ])
                ]),
                _vm._v(" "),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.storage_id,
                          expression: "storage_id"
                        }
                      ],
                      attrs: { id: "storage_id", name: "storage_id" },
                      on: {
                        change: function($event) {
                          ...
                          _vm.storage_id = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        }
                      }
                ...
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("label", { attrs: { for: "name" } }, [
                    _vm._v(_vm._s(this.translate("item.name")))
                  ]),
                  _vm._v(" "),
                  _c("input", {
                    attrs: { type: "hidden", id: "item_id", name: "item_id" },
                  ...
                  _c("input", {
                    ...
                    class: { error: _vm.validation.hasError("itemName") },
                  ...
                  _c("div", { staticClass: "message" }, [
                    _vm._v(_vm._s(_vm.validation.firstError("itemName")))
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("label", { attrs: { for: "description" } }, [
                    _vm._v(_vm._s(this.translate("item.description")))
                  ]),
                  _vm._v(" "),
                  _c(
                    "textarea",
                ...
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("input", {
                    attrs: { type: "submit" },
                    domProps: { value: this.translate("common.save") }
                  })
                ])
              ]
            )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-560a3f22", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_storage_list_vue__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44e9177c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_storage_list_vue__ = __webpack_require__(86);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_storage_list_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44e9177c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_storage_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/storage-list.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-44e9177c", Component.options)
  } else {
    hotAPI.reload("data-v-44e9177c", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__vue_translations_translations___default.a, __WEBPACK_IMPORTED_MODULE_1_vue_i18n_mixin___default.a],
  computed: Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapState"])({
    locale: state => state.locale,
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("transition", { attrs: { name: _vm.storageListTransition } }, [
    _vm.showStorageList
            ...
            _c(
              ...
              [
                _c("label", { staticClass: "first", attrs: { for: "name" } }, [
                  _vm._v(_vm._s(this.translate("storage.storage_spaces")))
                ]),
                _vm._v(" "),
                _c(
                  "transition-group",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-44e9177c", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_storage_form_vue__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_10eff0a2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_storage_form_vue__ = __webpack_require__(89);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_storage_form_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_10eff0a2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_storage_form_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/dashboard/storage-form.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10eff0a2", Component.options)
  } else {
    hotAPI.reload("data-v-10eff0a2", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_simple_vue_validator__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function () {
    return {
      alphabets: Object(__WEBPACK_IMPORTED_MODULE_3__vue_constants_constants__["alphabets"])(),
      numbers: Object(__WEBPACK_IMPORTED_MODULE_3__vue_constants_constants__["numbers"])()
    };
  },
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_4_vuex__["mapState"])({
    locale: state => state.locale,
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("transition", { attrs: { name: "slideRight" } }, [
    _vm.showStorageForm
      ? _c("div", { staticClass: "pure-g", attrs: { id: "item-storage" } }, [
          _c("div", { staticClass: "box" }, [
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("label", [
                    _vm._v(_vm._s(this.translate("storage.storage_identifier")))
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "pure-u-1-5" }, [
                  _c(
                    "select",
                    {
                      directives: [
                    ...
                    _vm._l(_vm.alphabets, function(alphabet) {
                      return _c(
                        "option",
                        { domProps: { value: alphabet.value } },
                        [
                          _vm._v(
                            "\n                  " +
                              _vm._s(alphabet.letter) +
                              "\n                "
                          )
                        ]
                      )
                ...
                _c("div", { staticClass: "pure-u-5-5" }, [
                  _c("label", { attrs: { for: "name" } }, [
                    _vm._v(_vm._s(this.translate("storage.storage_name")))
                  ]),
                  _vm._v(" "),
                  _c("input", {
                    attrs: { type: "hidden", name: "storage_id" },
                    domProps: { value: _vm.storageId }
                  }),
                  _vm._v(" "),
                  _c("input", {
                    directives: [
                    ...
                    class: { error: _vm.validation.hasError("storageName") },
                    attrs: {
                      type: "text",
                      id: "storage_name",
                      name: "storage_name"
                    },
                    domProps: { value: _vm.storageName },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "message" }, [
                    _vm._v(_vm._s(_vm.validation.firstError("storageName")))
                  ]),
                  _vm._v(" "),
                  _c("label", { attrs: { for: "description" } }, [
                    _vm._v(
                      _vm._s(this.translate("storage.storage_description"))
                    )
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    {
                      attrs: { id: "description", name: "description" },
                      domProps: { value: _vm.storageDescription }
                    },
                    [_vm._v(_vm._s(_vm.storageDescription))]
                  )
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "pure-u-5-5" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-10eff0a2", esExports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "transition",
        { attrs: { name: "fade" }, on: { "after-enter": _vm.show_item_form } },
        [
          _vm.showForm
            ? _c(
                "div",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cf9b6cda", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_bottom_widgets_vue__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ab3b784_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_bottom_widgets_vue__ = __webpack_require__(93);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_bottom_widgets_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ab3b784_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_bottom_widgets_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/js/vue/bottom-widgets.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7ab3b784", Component.options)
  } else {
    hotAPI.reload("data-v-7ab3b784", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])(['add_new_item'] //this.$store.dispatch('add_new_item')
  )
});
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _vm.loggedIn
    ? _c("div", { attrs: { id: "bottom-widgets" } }, [
        _c("div", { staticClass: "btn-add", on: { click: _vm.add_new_item } })
      ])
    : _vm._e()
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7ab3b784", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-28960a80", esExports)
  }
}
